  ...
  public createAnimations(): void {
    const animations: Phaser.Types.Animations.Animation[] = [
        { 
          ...
          frameRate: 12,
          frames: this.scene.anims.generateFrameNumbers(this.texture.key, { frames: [0, 1, 2, 3, 4] }),
        },
        {
          key: `${this.texture.key}-hurt`,
          frameRate: 12,
          frames: this.scene.anims.generateFrameNumbers(this.texture.key, { frames: [5, 6, 7, 8] }),
        },
        { 
          key: `${this.texture.key}-idle`,
          frameRate: 12,
          frames: this.scene.anims.generateFrameNumbers(this.texture.key, { frames: [9, 10, 11, 12, 13, 14, 15] }),
          repeat: -1, 
        },
        { 
